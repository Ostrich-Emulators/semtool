...
public class JenaSesameUtils {
    ...
    TreeModel aGraph = new TreeModel();
   ...
   *
   * @param inputVector Vector to be converted
   *
   * @return String Sesame string
   */
  public static String convertVectorToSesameString( Collection<String> inputVector ) {
    StringBuilder subjects = new StringBuilder();
    for ( String s : inputVector ) {
      subjects.append( "(<" ).append( s ).append( ">)" );
    }
   ...
   */
  public static String convertVectorToJenaString( Collection<String> inputVector ) {
    StringBuilder subjects = new StringBuilder();
    for ( String s : inputVector ) {
      subjects.append( "<" ).append( s ).append( ">" );
    }
