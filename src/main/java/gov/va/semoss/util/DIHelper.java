...
/**
 * DIHelper is used throughout SEMOSS to obtain property names from 
 * core propfiles and engine core propfiles.
 */
public class DIHelper {
  ...
  public String getProperty( String name ) {
	...
	/**
	 * Method getComboBox Convenience method to retrieve JComboBox<String> from the hashtable. 
