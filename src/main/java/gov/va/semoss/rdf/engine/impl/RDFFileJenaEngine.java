 ...
 * an RDF file (.jnl file).
 */
public abstract class RDFFileJenaEngine extends AbstractEngine {

	private static final Logger logger = Logger.getLogger( RDFFileJenaEngine.class );
