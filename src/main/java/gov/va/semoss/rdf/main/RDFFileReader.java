...
public class RDFFileReader {
  private static final Logger log = Logger.getLogger(RDFFileReader.class);
	/**
	 * Method main.
	 * @param args String[]
	 */
	public static void main(String [] args)
	{
		...
		log.debug("Completed loading file ");
		...
		log.debug("Iterating " + jenaModel.isEmpty());
		...
		while(sti.hasNext())
		{
			...
			log.debug("Statement " + stmt.getSubject() + "<>" + stmt.getPredicate() + "<>" + stmt.getObject());
		}*/
		while(rs.hasNext())
		{
			QuerySolution soln = rs.next();
			log.debug(soln.get("?subject"));
		}
