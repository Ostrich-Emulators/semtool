...
public class VertexShapeTransformer implements Transformer<SEMOSSVertex, Shape> {
	private Map<String, Double> vertSizeHash;
	private Map<String, Double> vertSelectionHash;
	 ...
	 * @param vertSizeHash
	 */
	public void setVertexSizeHash(Map<String, Double> vertSizeHash) {
	 ...
	 * 
	 * @param nodeURI
	 *            String - the URI of the node to be increased.
	 */
	 ...
	 * 
	 * @param nodeURI
	 *            String - the URI of the node to be decreased.
	 */
	...
	public void increaseSize() {
		...
		for (Map.Entry<String, Double> en : vertSizeHash.entrySet()) {
	 ...
	 * 
	 * @param vertex
	 *            DBCMVertex - The edge of which this returns the properties.
	 * 
	 * @return Shape - The name of the new shape.
	 */
	@Override
	public Shape transform(SEMOSSVertex vertex) {
		String URI = vertex.getURI();
		...
		if (!vertSizeHash.containsKey(URI)
				&& currentDefaultScale == initialDefaultScale
				&& !vertSelectionHash.containsKey(URI)) {
			return vertex.getShape();
		}

		double customScale = currentDefaultScale;
		if (vertSizeHash.containsKey(URI)) {
			customScale = vertSizeHash.get(vertex.getURI());
		}
