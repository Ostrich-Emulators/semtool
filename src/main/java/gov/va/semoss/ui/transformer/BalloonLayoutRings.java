...
public class BalloonLayoutRings implements VisualizationServer.Paintable {
	...
	private BalloonLayout<SEMOSSVertex, SEMOSSEdge> layout;
	private VisualizationViewer<SEMOSSVertex, SEMOSSEdge> vv;
	 ...
	 * @param layout Layout
	 */
	public void setLayout( BalloonLayout<SEMOSSVertex, SEMOSSEdge> layout ) {
		this.layout = layout;
	}
