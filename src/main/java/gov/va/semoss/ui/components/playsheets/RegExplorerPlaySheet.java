...
public class RegExplorerPlaySheet extends AbstractRDFPlaySheet{
	...
	private static final Logger log = Logger.getLogger( RegExplorerPlaySheet.class );
	String depVarText;
	List<String> indepVarTextList;
	List<Double> indepVarMedianValues;
	List<Double> indepVarSlopeValues;
	List<JPanel> indepPanelList = new ArrayList<>();
	JPanel depPanel;
...
//			this.setExtendedState(Frame.MAXIMIZED_BOTH);
			...
			log.error( "problem adding panel", e );
		}
	}
	
	public void setValues(String dependentVar,List<String> independentVarList,
      List<Double> independentVarMedianValues,List<Double> independentVarSlopeValues)
	{
