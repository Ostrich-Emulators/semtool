...
public class LabelTableModel extends AbstractTableModel {
	...
	private static final Logger logger = Logger.getLogger(LabelTableModel.class);
	...
	public Object getValueAt(int arg0, int arg1) {
		return data.getLabel(arg0, arg1);
	}
	...
	public Class<?> getColumnClass(int column) {
		if (data.getLabel(0, column)==null) {
			logger.debug("This cell is null[][][][][][][][][][][][][][][]");
			return String.class;
		}

		Class<?> theClass = data.getLabel(0, column).getClass();
