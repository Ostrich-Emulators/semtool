...
public class PropertySpecData implements GraphListener{
	...
	/**
	 * This method will read through the predicate hash and generate the data
	 * lists. It shows the boolean, concept hierarchy, predicate, concept, and
	 * concept boolean.
	 */
	...
	/**
	 * Adds subject, predicates, and/or properties into the appropriate
	 * hashtables.
	 *
