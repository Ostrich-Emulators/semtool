...
/**
 * When the refresh graph button is pressed, this gets the active sheet and
 * calls the repaint.
 */
public class FilterRefreshListener implements IChakraListener {

	private static final Logger logger
			= Logger.getLogger( FilterRefreshListener.class );
	...
	public void actionPerformed( ActionEvent actionevent ) {
		logger.debug( "Calling action performed - Refine" );
