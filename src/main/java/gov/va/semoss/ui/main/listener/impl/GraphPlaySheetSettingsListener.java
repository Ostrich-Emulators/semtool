...
/**
 * Gets all settings check boxes relating to the graph play sheet, grabs current
 * state of all settings, and updates state of all settings according to check
 * box values.
 */
public class GraphPlaySheetSettingsListener implements IChakraListener {

  private static final Logger logger
      = Logger.getLogger( GraphPlaySheetSettingsListener.class );
  ...
  public void actionPerformed( ActionEvent e ) {
    logger.debug( "Registering check box" );
