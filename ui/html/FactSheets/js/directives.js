    ...
    return {
        ...
        link: function(scope, ele, attrs) {
            ...
            function update(dataString) {
                var data = [{"label": "Create", "value":dataString.DATA_COUNT_QUERY[3]},{"label": "Modify", "value":dataString.DATA_COUNT_QUERY[2]}, {"label": "Read", "value": dataString.DATA_COUNT_QUERY[1]}];
                ...
                var color = function(iterator) {
                    if (iterator === 0) {
                        return ("#606060")//create
                    } else if (iterator === 1){
                        return ("#9BBBF4");//modify
                    } else {
						return ("#003399");//read
