...
//----------------------------------------------------------------------------------------------------
	...
	private void handleReload(ActionEvent event){ 
      ...
      *    the TreeView.
      *    
      * @param wim -- (WriteableInsightManager) Methods to persist changes to the Insights KB.
	  */
	 private boolean persistenceWrapper(ObservableList<TreeItem<Object>> olstPerspectives, WriteableInsightManager wim){
		boolean boolReturnValue = true;
