...
public class InsightManagerPanel_2 extends JPanel {
	...
	/**
	 * Creates the Scene-graph within the JFXPanel, and adds the JFXPanel to this
	 * JPanel.
	 *
	 */
	...
	/**
	 * Constructs this panel on the Swing thread. Called by the constructor, and
	 * externally, where a new object need not be constructed.
	 */
