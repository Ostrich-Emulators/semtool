...
public class RegCalculationPerformer implements IAlgorithm {
	...
	private static final Logger logger = Logger.getLogger( RegCalculationPerformer.class );

	RegressionAnalysisPlaySheet regPlaySheet;
	String nodeUri;
	String dependentVar;
	List<String> independentVarList;
	double[] yValues;
	double[][] xValues;
	...
	/**
	 * Method regCalculate. Calculates the regression coefficients for the
	 * selected dependent variables and regressors and then creates a new tab to
	 * display on.
	 */
	...
	/**
	 * Method runQuery. Creates and executes the query to pull statistics from the
	 * database that are necessary for the regression analysis.
	 */
	 ...
	 */
	public void setPlaySheet( RegressionAnalysisPlaySheet playSheet ) {
		regPlaySheet = playSheet;
	}
	 ...
	 */
	public void setIndependentVar( List<String> indepVarModelList ) {
