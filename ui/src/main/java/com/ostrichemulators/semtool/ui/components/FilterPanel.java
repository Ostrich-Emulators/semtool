...
public class FilterPanel extends javax.swing.JPanel {
	private static final long serialVersionUID = 6503082048407583367L;
  ...
  // End of variables declaration//GEN-END:variables
	...
	public void setEngine( IEngine eng ) {
		...
		for (URI key:displayNames.keySet()) {
			pr.cache( key, displayNames.get(key) );
		}
	...
	private class ShowRenderer extends LabeledPairTableCellRenderer<Value> {
		private static final long serialVersionUID = -1065887829455367957L;
