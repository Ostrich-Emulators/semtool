...
import com.ostrichemulators.semtool.user.AbstractUser;
 ...
 * @author ryan
 */
public class SemossUser extends LdapUserDetailsImpl implements com.ostrichemulators.semtool.user.User {
