...
import gov.va.semoss.web.controller.DatabaseController;
import gov.va.semoss.web.controller.LoginController;
...
public class ProxyController  {
	private static final Logger log = Logger.getLogger( ProxyController.class );
	  ...
	  public static final String CONTROLLER_NAME = "SEMOSS_DB_SERVER";
	  
	  /** The parameter name for the target (destination) URI to proxy to. */
	  protected static final String P_TARGET_URI = "targetUri";
	  protected static final String ATTR_TARGET_URI =
	          DatabaseController.class.getSimpleName() + ".targetUri";
	  protected static final String ATTR_TARGET_HOST =
			  DatabaseController.class.getSimpleName() + ".targetHost";
	  ...
	  public void tearDown() {
	    ...
	    if (proxyClient instanceof Closeable) {//TODO AutoCloseable in Java 1.6
	      try {
	        ...
	        log.error("While destroying servlet, shutting down HttpClient: ", e);
	      }
	    } else {
	  ...
	  public void proxyRequest( HttpServletRequest servletRequest, HttpServletResponse servletResponse)
